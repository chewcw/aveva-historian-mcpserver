...
func TestNewServerRegistersNinePrompts(t *testing.T) {
	...
	want := []string{"current_status", "tag_profiler", "tag_explorer", "trend_report", "compare_tags", "energy_usage", "batch_summary", "alarm_review", "daily_ops_summary"}
